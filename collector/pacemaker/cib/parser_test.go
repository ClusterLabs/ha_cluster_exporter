...
func TestParse(t *testing.T) {
	...
	assert.Equal(t, "stonith-sbd-instance_attributes", data.Configuration.Resources.Primitives[0].InstanceAttributes.Id)
	assert.Equal(t, 1, len(data.Configuration.Resources.Primitives[0].InstanceAttributes.NvPairs))
	assert.Equal(t, "pcmk_delay_max", data.Configuration.Resources.Primitives[0].InstanceAttributes.NvPairs[0].Name)
	assert.Equal(t, "stonith-sbd-instance_attributes-pcmk_delay_max", data.Configuration.Resources.Primitives[0].InstanceAttributes.NvPairs[0].Id)
	assert.Equal(t, "30s", data.Configuration.Resources.Primitives[0].InstanceAttributes.NvPairs[0].Value)
	assert.Equal(t, "msl_SAPHana_PRD_HDB00", data.Configuration.Resources.Masters[0].Id)
	assert.Equal(t, 3, len(data.Configuration.Resources.Masters[0].MetaAttributes.NvPairs))
